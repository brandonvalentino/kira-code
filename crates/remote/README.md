...
The `remote` crate contains the implementation of the Kira Code hosted API.
...
KIRACODE_REMOTE_JWT_SECRET=your_base64_encoded_secret
...
Generate `KIRACODE_REMOTE_JWT_SECRET` once using `openssl rand -base64 48` and copy the value into `.env.remote`.
