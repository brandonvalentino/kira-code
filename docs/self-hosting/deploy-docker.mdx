...
```bash
git clone https://github.com/BloopAI/kira-code.git
cd kira-code
```
...
```env .env.remote
# Required secrets
KIRACODE_REMOTE_JWT_SECRET=<your_generated_jwt_secret>
...
services:
  ...
  remote-server:
    ...
    environment:
      ...
      KIRACODE_REMOTE_JWT_SECRET: ${KIRACODE_REMOTE_JWT_SECRET}
