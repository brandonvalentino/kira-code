...
On the client device where you'd now like to access your host machine from, navigate to [cloud.kiracode.com](https://cloud.kiracode.com) in a browser and log in.
